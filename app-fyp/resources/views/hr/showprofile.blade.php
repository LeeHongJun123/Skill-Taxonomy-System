        ...
        <div class="container mt-5">   
            <div>
                ...
                <div class="d-flex justify-content-end align-items-center">
                    <a href="{{ route('Hrview.profile') }}" class="btn btn-outline-success mr-2">Back</a>
                    <a href="{{ route('hr_profile.pdf', $user->id) }}" class="btn btn-outline-success">Print Profile</a>
                </div>
