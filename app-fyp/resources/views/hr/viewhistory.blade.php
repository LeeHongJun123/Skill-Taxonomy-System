...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container mt-5">
            ...
            <a href="{{ route('Hrview.profile') }}" class="btn btn-outline-success">Back</a>
            <a href="{{ route('hr_career-history.pdf', $user->id) }}" class="btn btn-outline-success">Print Career History</a>
        </div>
    </div>
    <footer class="footer">
