...
<div class="main-content">
    ...
    <br>
    <hr>
    <a href="{{ route('skill.create') }}" class="btn btn-primary">Add New Skills</a>
            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{route('skill.edit',['skill' => $skill])}}" class="btn btn-primary">Edit</a>
                        </td>
                        <td>
                            <form method='post' action='{{route('skill.delete', ['skill'=>$skill])}}'>
                                @csrf
                                @method('delete')
