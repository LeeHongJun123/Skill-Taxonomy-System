...
<body>
<div>
    @if(session()->has('Success')) <!-- Ensure the spelling matches your session key -->
...
<div class="main-content">
    ...
    <div class="container mt-5">
        ...
        <form method='post' action="{{route('skill.update', ['skill' => $skill])}}" >
            @csrf
            @method('put')

            <div>
                <label>Skill Name</label>
                <input type="text" class="form-control" name='Name' placeholder="Example: HTML 5" value='{{$skill->Name}}'/>
            </div>
